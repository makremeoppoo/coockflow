  ...
  try {
    ...
    const file = {
      ...
      type: mimeType,
        uri: imageUrl,
      size:1000
      // Remove size - Appwrite will determine it automatically
    };
    ...
    // BUILD URL MANUALLY AS A STRING (don't use getFileView)
...
async function seed(): Promise<void> {
    ...
    for (const item of data.menu) {
        ...
        console.log("menu_customizations")
